...
import (
	...
	"github.com/arminguenther/xeruspower-go/v40040/peripheral/peripheraldevicepackage"
...
func (s *_DeviceManagerSettingsChangedEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "peripheral.DeviceManager_5_1_3.SettingsChangedEvent",
...
func (d *_DeviceManagerDeviceEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "peripheral.DeviceManager_5_1_3.DeviceEvent",
		Major: 1, Submajor: 0, Minor: 0,
	}
}
...
func (d *_DeviceManagerDeviceAddedEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "peripheral.DeviceManager_5_1_3.DeviceAddedEvent",
		Major: 1, Submajor: 0, Minor: 0,
	}
}
...
func (d *_DeviceManagerDeviceRemovedEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "peripheral.DeviceManager_5_1_3.DeviceRemovedEvent",
		Major: 1, Submajor: 0, Minor: 0,
	}
}
...
func (u *_DeviceManagerUnknownDeviceAttachedEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "peripheral.DeviceManager_5_1_3.UnknownDeviceAttachedEvent",
		Major: 1, Submajor: 0, Minor: 0,
	}
}
...
func (d *_DeviceManagerDeviceFirmwareUpdateStateChangedEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "peripheral.DeviceManager_5_1_3.DeviceFirmwareUpdateStateChangedEvent",
		Major: 1, Submajor: 0, Minor: 0,
	}
}
...
func (f *_DeviceManagerFirmwareUpdateStateChangedEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "peripheral.DeviceManager_5_1_3.FirmwareUpdateStateChangedEvent",
		Major: 1, Submajor: 0, Minor: 0,
	}
}
...
func (p *_DeviceManagerPackageEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "peripheral.DeviceManager_5_1_3.PackageEvent",
		Major: 1, Submajor: 0, Minor: 0,
	}
}
...
func (p *_DeviceManagerPackageAddedEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "peripheral.DeviceManager_5_1_3.PackageAddedEvent",
		Major: 1, Submajor: 0, Minor: 0,
	}
}
...
func (p *_DeviceManagerPackageRemovedEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "peripheral.DeviceManager_5_1_3.PackageRemovedEvent",
		Major: 1, Submajor: 0, Minor: 0,
	}
}
