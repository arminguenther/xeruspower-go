...
func (c *_CascadeManager) AddZigbeeLinkUnit(ctx context.Context, in0 int32, in1 string, in2 string) (int32, error) {
	var ret int32
	val, err := c.Caller().Call(ctx, c.RID(), "addZigbeeLinkUnit", map[string]any{
		"linkId":     in0,
		"address":    in1,
		"installKey": in2,
	})
