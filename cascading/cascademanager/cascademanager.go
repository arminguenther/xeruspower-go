...
type CascadeManager interface {
	...
	//	@param login                 The administrator login for the link unit
	//	@param password              The administrator password for the link unit
	//	@param positionDependent     If true, host names that depend on the node index will be used.
	...
	//
	//	@param linkId       The ID for the new link unit
	//	@param installKey   The install key from the Base unit's label (32 or 36 hex digits)
	//
	//	@return NO_ERROR                       The operation was successful
	//	@return ERR_INVALID_PARAM              One of the parameters had an invalid value
	//	@return ERR_UNSUPPORTED_ON_LINK_UNIT   This unit is currently a link unit and can't have link units of its own
	...
	//
	//	@param linkId       The ID for the new link unit
	//	@param address      Zigbee device address (16 hex digits)
	//	@param installKey   The install key from the Base unit's label (with CRC, 36 hex digits)
	//
	//	@return NO_ERROR                       The operation was successful
	//	@return ERR_INVALID_PARAM              One of the parameters had an invalid value
	//	@return ERR_UNSUPPORTED_ON_LINK_UNIT   This unit is currently a link unit and can't have link units of its own
	//	@return ERR_LINK_ID_IN_USE             The specified link ID is already in use
	//	@return ERR_NOT_SUPPORTED              This device does not support PDU linking
	AddZigbeeLinkUnit(ctx context.Context, linkId int32, address string, installKey string) (int32, error)
}
...
const (
	...
	ZIGBEE                            // Linking via Zigbee (ScalePoint)
)
...
const (
	...
	WAITING                                 // Waiting for link unit pairing request
	PAIRING_TIMEOUT                         // Timeout waiting for pairing request
	PAIRING                                 // Pairing with the link unit is in progress
)
...
type Status struct {
	...
	PrimaryLinkId int32              // The link ID of the always-present first unit
