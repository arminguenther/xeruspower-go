...
type Channel interface {
	...
	// Releases the channel to allow lower prioritized clients to view an image otherwise the channel expires when
	// it is unused (neither an image related method nor "isAvailable" is called) for 20 seconds.
