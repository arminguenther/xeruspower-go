...
func (s *_SensorsChangedEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "pdumodel.OutletGroup_1_1_11.SensorsChangedEvent",
...
func (s *_SettingsChangedEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "pdumodel.OutletGroup_1_1_11.SettingsChangedEvent",
		Major: 1, Submajor: 0, Minor: 0,
	}
}
...
func (p *_PowerControlEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "pdumodel.OutletGroup_1_1_11.PowerControlEvent",
		Major: 1, Submajor: 0, Minor: 0,
	}
}
