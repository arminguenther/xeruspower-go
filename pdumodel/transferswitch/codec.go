...
import (
	...
	"github.com/arminguenther/xeruspower-go/v40412/pdumodel/transferswitchbypassstatesensor"
...
func (s *Statistics) Encode() map[string]any {
	...
	j0["overloadCount"] = s.OverloadCount
	j0["switchOvercurrentCount"] = s.SwitchOvercurrentCount
	return j0
}
...
func (s *Statistics) Decode(v any, caller idl.Caller) error {
	...
	err = encoding.In("overloadCount", j0)
	if err != nil {
		return err
	}
	s.OverloadCount, err = encoding.AsInt32(j0["overloadCount"])
	if err != nil {
		return err
	}
	err = encoding.In("switchOvercurrentCount", j0)
	if err != nil {
		return err
	}
	s.SwitchOvercurrentCount, err = encoding.AsInt32(j0["switchOvercurrentCount"])
	if err != nil {
		return err
	}
	return nil
