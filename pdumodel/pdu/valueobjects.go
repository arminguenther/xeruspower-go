...
func (s *_SettingsChangedEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "pdumodel.Pdu_6_5_7.SettingsChangedEvent",
...
func (l *_LoadSheddingModeChangedEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "pdumodel.Pdu_6_5_7.LoadSheddingModeChangedEvent",
		Major: 1, Submajor: 0, Minor: 0,
	}
}
...
func (o *_OutletSequenceStateChangedEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "pdumodel.Pdu_6_5_7.OutletSequenceStateChangedEvent",
		Major: 1, Submajor: 0, Minor: 0,
	}
}
...
func (p *_PortAppearedEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "pdumodel.Pdu_6_5_7.PortAppearedEvent",
		Major: 1, Submajor: 0, Minor: 0,
	}
}
...
func (p *_PortDisappearedEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "pdumodel.Pdu_6_5_7.PortDisappearedEvent",
		Major: 1, Submajor: 0, Minor: 0,
	}
}
