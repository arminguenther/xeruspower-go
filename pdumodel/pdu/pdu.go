...
type Pdu interface {
	...
	//
	//	@param portType filter for port type, or use peripheral.PortType.UNSPECIFIED
	...
	// Get all power supplies in the power shelf controlled by this PDU
	//
	//	@return List of power supplies
	GetShelfPowerSupplies(ctx context.Context) ([]shelfpowersupply.ShelfPowerSupply, error)

	// Get the power bus in the power shelf controlled by this PDU
	//
	//	@return Power bus of this shelf
	GetShelfPowerBus(ctx context.Context) (powerbus.PowerBus, error)
...
type MetaData struct {
	...
	// MAC address; Deprecated, please use net::Net::getInfo
	// to determine the MAC address for each physical interface
	MacAddress              string
...
type Settings struct {
	...
	StartupState     StartupState // Default outlet state after applying power to outlets; can be overridden per outlet
	CycleDelay       int32        // Default power-cycle interval in seconds; can be overridden per outlet
