...
import (
	...
	"github.com/arminguenther/xeruspower-go/v40412/hmi/internalbeeper"
	...
	"github.com/arminguenther/xeruspower-go/v40412/pdumodel/inlet"
	"github.com/arminguenther/xeruspower-go/v40412/pdumodel/nameplate"
	"github.com/arminguenther/xeruspower-go/v40412/pdumodel/outlet"
	"github.com/arminguenther/xeruspower-go/v40412/pdumodel/overcurrentprotector"
	"github.com/arminguenther/xeruspower-go/v40412/pdumodel/powerbus"
	"github.com/arminguenther/xeruspower-go/v40412/pdumodel/shelfpowersupply"
	"github.com/arminguenther/xeruspower-go/v40412/pdumodel/transferswitch"
	"github.com/arminguenther/xeruspower-go/v40412/peripheral/peripheraldevicemanager"
	"github.com/arminguenther/xeruspower-go/v40412/peripheral/poselement"
	"github.com/arminguenther/xeruspower-go/v40412/portsmodel/port"
	"github.com/arminguenther/xeruspower-go/v40412/sensors/alertedsensormanager"
	"github.com/arminguenther/xeruspower-go/v40412/sensors/sensorlogger"
)
...
func (p *_Pdu) GetShelfPowerSupplies(ctx context.Context) ([]shelfpowersupply.ShelfPowerSupply, error) {
	var ret []shelfpowersupply.ShelfPowerSupply
	val, err := p.Caller().Call(ctx, p.RID(), "getShelfPowerSupplies", nil)
	if err != nil {
		return ret, err
	}
	res, err := encoding.Is[map[string]any](val)
	...
	ret = make([]shelfpowersupply.ShelfPowerSupply, 0, len(s0))
	for _, a0 := range s0 {
		var e0 shelfpowersupply.ShelfPowerSupply
		e0, err = object.As[shelfpowersupply.ShelfPowerSupply](a0, p.Caller())
		if err != nil {
			return ret, err
		}
		ret = append(ret, e0)
...
func (p *_Pdu) GetShelfPowerBus(ctx context.Context) (powerbus.PowerBus, error) {
	var ret powerbus.PowerBus
	val, err := p.Caller().Call(ctx, p.RID(), "getShelfPowerBus", nil)
	if err != nil {
		return ret, err
	}
	res, err := encoding.Is[map[string]any](val)
	...
	ret, err = object.As[powerbus.PowerBus](res["_ret_"], p.Caller())
	if err != nil {
		return ret, err
	}
	return ret, nil
