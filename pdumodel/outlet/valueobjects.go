...
func (p *_PowerControlEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "pdumodel.Outlet_3_0_4.PowerControlEvent",
...
func (s *_StateChangedEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "pdumodel.Outlet_3_0_4.StateChangedEvent",
		Major: 1, Submajor: 0, Minor: 0,
	}
}
...
func (s *_SettingsChangedEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "pdumodel.Outlet_3_0_4.SettingsChangedEvent",
		Major: 1, Submajor: 0, Minor: 0,
	}
}
...
func (s *_ServiceModeChangedEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "pdumodel.Outlet_3_0_4.ServiceModeChangedEvent",
		Major: 1, Submajor: 0, Minor: 0,
	}
}
