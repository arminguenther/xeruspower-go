...
const (
	...
	ERR_OUTLET_NOT_OFF         int32 = 4 // Outlet is on or in power-cycle (obsolete)
...
type Sensors struct {
	...
	InrushCurrent           numericsensor.NumericSensor // In-rush current occurring after turning outlet on
