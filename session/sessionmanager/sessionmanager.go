...
// Depending on transport protocol an established session
// allows simplified authentication using the session token.
// For instance, for HTTP transport implementation session token
...
// than session timeout. Idle timer is implicitly touched
