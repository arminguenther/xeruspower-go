...
type Diagnostics interface {
	...
	//	@return ERR_EXEC_FAIL        if an error occurred during execution of the socket statistic utility
	...
	//	@param results               result (includes metadata and the actual result or error message)
