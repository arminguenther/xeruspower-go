...
func init() {
	valobj.Register(func() LoggerBackupFailureEvent { return &_LoggerBackupFailureEvent{} })
	valobj.Register(func() LoggerBackupStateChangedEvent { return &_LoggerBackupStateChangedEvent{} })
...
func (i *_LoggerInfoChangedEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "sensors.Logger_3_1_6.InfoChangedEvent",
...
func (s *_LoggerSettingsChangedEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "sensors.Logger_3_1_6.SettingsChangedEvent",
		Major: 1, Submajor: 0, Minor: 0,
	}
}
...
func (l *_LoggerLoggedSensorsChangedEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "sensors.Logger_3_1_6.LoggedSensorsChangedEvent",
		Major: 1, Submajor: 0, Minor: 0,
	}
}
...
type _LoggerBackupStateChangedEvent struct {
	event.Event
	backupState LoggerBackupState
}

func (b *_LoggerBackupStateChangedEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "sensors.Logger_3_1_6.BackupStateChangedEvent",
		Major: 1, Submajor: 0, Minor: 0,
	}
}

func (b *_LoggerBackupStateChangedEvent) BackupState() LoggerBackupState {
	return b.backupState
}

func (b *_LoggerBackupStateChangedEvent) isLoggerBackupStateChangedEvent() {}

type _LoggerBackupFailureEvent struct {
	event.Event
	errMsg string
}

func (b *_LoggerBackupFailureEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "sensors.Logger_3_1_6.BackupFailureEvent",
		Major: 1, Submajor: 0, Minor: 0,
	}
}

func (b *_LoggerBackupFailureEvent) ErrMsg() string {
	return b.errMsg
}

func (b *_LoggerBackupFailureEvent) isLoggerBackupFailureEvent() {}
