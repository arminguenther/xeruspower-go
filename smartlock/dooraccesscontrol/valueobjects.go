...
func (d *_DoorAccessGrantedEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "smartlock.DoorAccessControl_1_1_1.DoorAccessGrantedEvent",
...
func (d *_DoorAccessDeniedEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "smartlock.DoorAccessControl_1_1_1.DoorAccessDeniedEvent",
		Major: 1, Submajor: 0, Minor: 0,
	}
}
...
func (d *_DoorAccessRuleAddedEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "smartlock.DoorAccessControl_1_1_1.DoorAccessRuleAddedEvent",
		Major: 1, Submajor: 0, Minor: 0,
	}
}
...
func (d *_DoorAccessRuleChangedEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "smartlock.DoorAccessControl_1_1_1.DoorAccessRuleChangedEvent",
		Major: 1, Submajor: 0, Minor: 0,
	}
}
...
func (d *_DoorAccessRuleDeletedEvent) TypeCode() idl.TypeCode {
	return idl.TypeCode{
		Name:  "smartlock.DoorAccessControl_1_1_1.DoorAccessRuleDeletedEvent",
		Major: 1, Submajor: 0, Minor: 0,
	}
}
