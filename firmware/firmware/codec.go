...
func (u *UpdateHistoryEntry) Encode() map[string]any {
	...
	j0["platform"] = u.Platform
	j0["imageMD5"] = u.ImageMD5
	j0["status"] = u.Status
	j0["details"] = u.Details
	return j0
}
...
func (u *UpdateHistoryEntry) Decode(v any, caller idl.Caller) error {
	...
	u.Platform, err = encoding.Is[string](j0["platform"])
	if err != nil {
		return err
	}
	...
	err = encoding.In("details", j0)
	if err != nil {
		return err
	}
	u.Details, err = encoding.Is[string](j0["details"])
	if err != nil {
		return err
	}
	return nil
