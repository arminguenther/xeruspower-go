...
// called back in case new events have occurred. Subscription
...
type Consumer interface {
	...
	// function but return immediately. Policy of how often and
...
type Channel interface {
	...
	//
	//	@param type typecode of valueobject of demanded event
	...
	//
	//	@param types  List of event typecodes
	DemandEventTypes(ctx context.Context, types []idl.TypeCode) error

	// Cancel subscription for events of given types.
	//
	//	@param types  List of event typecodes
