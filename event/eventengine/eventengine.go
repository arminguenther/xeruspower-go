...
type Engine interface {
	...
	// Add a new action.
	//
	// The id and isSystem fields are ignored. The action's id field is
	...
	// id field is allocated automatically and returned in the ruleId
	// parameter.
	//
	//	@return 0 if OK
...
// vector that is passed to the action and varies depending on type.
...
// the rule as not deletable. The 'actionIds' are the actions to
